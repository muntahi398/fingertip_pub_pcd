...
int main(int argc, char **argv)
{
    ...
    ros::Publisher vl_sens0,vl_sens1,vl_sens2,vl_sens3,vl_sens4,vl_sens5,vl_sens6,vl_sens7,vl_sens8,vl_sens9;//("s", &range_msg);  //pub_range("/ultrasound", &range_msg);
    node_class this_node;
    bool init_worked = this_node.init();
//    vl_sens0=advertise<std_msgs::string>("chatter", 1000);;
...
//        cout << "range_val ="<<sensor1.range_val << endl;
        ...
        range_msg.range=(*sens2).range_val;

//        if ((*sens2).sensor_no==1)
//            vl_sens0.publish(&range_msg);
//        else if ((*sens2).sensor_no==2)
//            vl_sens1.publish(&range_msg);
//        else if ((*sens2).sensor_no==3)
//            vl_sens2.publish(&range_msg);
//        else if ((*sens2).sensor_no==4)
//            vl_sens3.publish(&range_msg);
//        else if ((*sens2).sensor_no==5)
//            vl_sens4.publish(&range_msg);
//        else if ((*sens2).sensor_no==6)
//            vl_sens5.publish(&range_msg);
//        else if ((*sens2).sensor_no==7)
//            vl_sens6.publish(&range_msg);
//        else if ((*sens2).sensor_no==8)
//            vl_sens7.publish(&range_msg);
//        else if ((*sens2).sensor_no==9)
//            vl_sens8.publish(&range_msg);
//        else if ((*sens2).sensor_no==10)
//            vl_sens9.publish(&range_msg);
